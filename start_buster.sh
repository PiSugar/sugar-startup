...
syncthingrelease="v1.8.0"
syncthingaddress="http://cdn.pisugar.com/release"
...
sudo echo -e "deb ${source}/raspbian/raspbian/ buster main contrib non-free rpi \ndeb-src ${source}/raspbian/raspbian/ buster main contrib non-free rpi" > /etc/apt/sources.list
sudo echo -e "deb ${source}/raspberrypi/ buster main ui \ndeb-src ${source}/raspberrypi/ buster main ui" > /etc/apt/sources.list.d/raspi.list
...
syncthinglink="${syncthingaddress}/${syncthingversion}-${syncthingrelease}.tar.gz"
#syncthinglink="http://cdn.pisugar.com/release/syncthing-linux-arm-v1.8.0.tar.gz"
wget ${syncthinglink}
